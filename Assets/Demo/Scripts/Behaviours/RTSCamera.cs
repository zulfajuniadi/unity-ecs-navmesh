    ...
    public class RTSCamera : MonoBehaviour
    {
        ...
        private void Move (float deltaTime)
        {
            ...
            if (Input.touchCount > 0 && Input.GetTouch (0).phase == TouchPhase.Moved)
            {
                ...
                transform.Translate (-touchDeltaPosition.x * panningSpeedMobile * deltaTime, -touchDeltaPosition.y * panningSpeedMobile * deltaTime, 0);
            }
        }
        ...
        private void Rotation (float deltaTime)
        {
            ...
            {
                transform.Rotate (Vector3.up, RotationDirection * deltaTime * rotationSped, Space.World);
            }

            if (useMouseRotation && Input.GetKey (mouseRotationKey))
            {
                m_Transform.Rotate (Vector3.up, -MouseAxis.x * deltaTime * mouseRotationSpeed, Space.World);
            }
        }
        ...
        private void FollowTarget (float deltaTime)
        {
            ...
            m_Transform.position = Vector3.MoveTowards (m_Transform.position, targetPos, deltaTime * followingSpeed);
        }
